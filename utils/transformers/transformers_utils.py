...
def download_weights(backbone_type, patch_size, pretrained_type):
    ...
    checkpoints_dino = {
        "deit_small": {
            8: "https://dl.fbaipublicfiles.com/dino/dino_deitsmall8_pretrain/dino_deitsmall8_pretrain.pth",
    ...
    checkpoints_sup = {
        "deit_tiny": {
            16: "https://dl.fbaipublicfiles.com/deit/deit_tiny_patch16_224-a1311bcf.pth"
        },
        "deit_small": {
            16: "https://dl.fbaipublicfiles.com/deit/deit_small_patch16_224-cd65a155.pth"
        },
        "deit_base": {
            8: "https://dl.fbaipublicfiles.com/deit/deit_base_patch8_224-b5f2ef4d.pth",
            16: "https://dl.fbaipublicfiles.com/deit/deit_base_patch16_224-b5f2ef4d.pth"
        },
    }
    ...
    try:
        chpt = torch.hub.load_state_dict_from_url(
            checkpoints[pretrained_type][backbone_type][patch_size], progress=True
        )
